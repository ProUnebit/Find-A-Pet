...
function fetchAnimals(e) {
    ...
    (0, _fetchJsonp2.default)('http://api.petfinder.com/pet.find?format=json&key=f17ffec197220acc8564aee272dd76e2&animal=' + animal + '&location=' + zip + '&callback=callback', { jsonpCallbackFunction: 'callback' }).then(function (res) {
        return res.json();
    }).then(function (data) {
...
//     console.log(data)
// }
},{"fetch-jsonp":"node_modules\\fetch-jsonp\\build\\fetch-jsonp.js"}],"C:\\Users\\Алексей\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '8787' + '/');
...
//# sourceMappingURL=/main.4d454fc6.map